...
import { MessageSquare, Mail, Globe, ArrowRight } from "lucide-react";
...
const FloatingCard = ({ icon: Icon, title, value, sub, action, href }) => (
  ...
  >
    ...
    <div className="z-10 mt-2">
      <h3 className="text-slate-300 text-xs font-bold uppercase tracking-widest mb-1 group-hover:text-brand-dark/70">
        {title}
      </h3>
      <p className="text-xl font-bold text-white mb-1 group-hover:text-white">
        {value}
      </p>
      <p className="text-sm text-slate-400 group-hover:text-white/90 leading-tight">
        {sub}
      </p>
    </div>
          ...
          <div className="lg:w-1/2">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight leading-[1.1] mb-6">
              ...
              <span className="relative inline-block">
                ...
                <svg
                  className="absolute w-full h-4 -bottom-1 left-0 text-brand-green"
                  viewBox="0 0 100 10"
            ...
            <p className="text-lg text-slate-300 leading-relaxed max-w-lg mb-8 border-l-2 border-brand-green/30 pl-6">
              Whether you're a company looking to hire or a talent looking for
              your next role in Germany, our local team in Berlin is ready to
              help.
            </p>
          </div>
