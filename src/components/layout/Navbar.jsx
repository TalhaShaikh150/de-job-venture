      ...
      <nav className="fixed top-0 left-0 w-full z-50 border-b border-white/5 bg-[#161F33] backdrop-blur-sm">
        ...
        <div className="container mx-auto px-6 h-20 flex justify-between items-center relative z-50 bg-[#161F33]/0">
          ...
          <div className="hidden md:flex gap-10 h-full">
            ...
            <NavLink to="/listing" className={desktopLinkClass}>Find Jobs</NavLink>
            <NavLink to="/companies" className={desktopLinkClass}>Companies</NavLink>
            <NavLink to="/salaries" className={desktopLinkClass}>Salaries</NavLink>
          </div>
          ...
          >
            <div className="flex flex-col justify-between w-6 h-5 relative">
              <span className={`h-[2px] w-full bg-white rounded transition-all duration-300 ${isOpen ? "rotate-45 translate-y-2.5" : ""}`}></span>
              <span className={`h-[2px] w-full bg-white rounded transition-all duration-300 ${isOpen ? "opacity-0" : "opacity-100"}`}></span>
              <span className={`h-[2px] w-full bg-white rounded transition-all duration-300 ${isOpen ? "-rotate-45 -translate-y-2" : ""}`}></span>
            </div>
          </button>
        </div>
        ...
        >
          ...
          <div className="flex flex-col gap-6 relative z-10 w-full max-w-sm mx-auto pt-20">
            ...
            <NavLink to="/companies" className={mobileLinkClass}>Companies</NavLink>
            <NavLink to="/salaries" className={mobileLinkClass}>Salaries</NavLink>
            <NavLink to="/career-advice" className={mobileLinkClass}>Career Advice</NavLink>
            ...
            <div className="mt-8 pt-8 border-t border-white/10 flex flex-col gap-4">
              ...
              <div className="flex items-center justify-center gap-2 mt-2">
                ...
                <Link to="/login" className="text-white font-bold text-sm underline decoration-brand-green decoration-2 underline-offset-4">
                  Sign In
                </Link>
              </div>
            </div>
