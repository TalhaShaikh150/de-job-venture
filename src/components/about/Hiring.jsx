        ...
        <div className="relative">
          ...
          <div className="relative lg:absolute lg:bottom-12 lg:left-12 lg:w-[500px] bg-brand-dark p-10 rounded-[2rem] shadow-2xl mt-[-50px] lg:mt-0 mx-4 lg:mx-0">
             ...
             <p className="text-slate-400 mb-8 leading-relaxed">
               Remote-first, impact-driven, and obsessed with quality. If you love solving complex problems, we want you.
             </p>

             <ul className="grid grid-cols-2 gap-4 mb-8">
                <li className="text-white text-sm font-bold flex items-center gap-2">
                   <div className="w-1.5 h-1.5 rounded-full bg-brand-green"></div> Remote
                </li>
                <li className="text-white text-sm font-bold flex items-center gap-2">
                   <div className="w-1.5 h-1.5 rounded-full bg-brand-green"></div> Equity
                </li>
                <li className="text-white text-sm font-bold flex items-center gap-2">
                   <div className="w-1.5 h-1.5 rounded-full bg-brand-green"></div> Health
                </li>
                <li className="text-white text-sm font-bold flex items-center gap-2">
                   <div className="w-1.5 h-1.5 rounded-full bg-brand-green"></div> Retreats
                </li>
             </ul>

             <a href="#" className="w-full bg-white text-brand-dark font-bold py-4 rounded-xl hover:bg-brand-green transition-colors flex items-center justify-center gap-2">
